...
def PAGE_NOT_FOUND(request):
    ...
    return render(request,'error/404.html',category)
...
#                 messages.error(request, f"BadRequestError: {e}")
#                 return redirect('checkout', slug=slug)
#             except razorpay.errors.ServerError as e:
#                 messages.error(request, f"ServerError: {e}")
#                 return redirect('checkout', slug=slug)
#             except razorpay.errors.NetworkError as e:
#                 messages.error(request, f"NetworkError: {e}")
#                 return redirect('checkout', slug=slug)
